/* Rainbow v2.1.7 rainbowco.de | included languages: c, csharp, css, generic, html, java, javascript, json, php, python, ruby */ !(function (
  e,
  t
) {
  ...
  function u(e, t, n, r) {
    var a = r.substr(e);
    return (n = n.replace(/\$/g, "$$$$")), r.substr(0, e) + a.replace(t, n);
  }
  function s(t, Prism) {
    if (e())
      return (global.Worker = require("web-worker")), new Worker(__filename);
  ...
  function c(e) {
    ...
    if (n.isNode) return void t();
    setTimeout(function () {
      t();
    }, 1e3 * n.options.delay);
  }
  function f() {
    return (A || null === j) && (j = s(c, Prism)), j;
  }
  function l(e, t) {
    function n(a) {
      a.data.id === e.id &&
        (t(a.data), r.removeEventListener("message", n), A && r.terminate());
    }
    var r = f();
  ...
  function m(e, t) {
    var n = {};
    return (
      "object" == typeof t && ((n = t), (t = n.language)),
      (t = S[t] || t),
      { id: x++, code: e, lang: t, options: g(n), isNode: A }
    );
  }
  function p(e, n) {
    for (var r = { c: 0 }, a = 0, o = e; a < o.length; a += 1) {
      ...
      if (!i.classList.contains("rainbow") && u) {
        ...
        ++r.c,
          l(
            m(i.innerHTML, { language: u, globalClass: s, delay: c }),
            d(i, r, n)
          );
      }
    }
  ...
  var E,
    Prism = function Prism(e) {
      function t(e, t) {
        for (var r in h)
          if (
            ((r = parseInt(r, 10)),
            n(r, h[r], e, t) && (delete h[r], delete v[r]),
            o(r, h[r], e, t))
          )
            return !0;
        return !1;
      ...
      function l(n, r, o) {
        ...
        !n.name &&
          n.matches &&
          "string" == typeof n.matches[0] &&
          ((n.name = n.matches[0]), delete n.matches[0]);
        var g = d[0],
          m = d.index + o,
          b = d[0].length + m;
        if (m === b) return !1;
        if (t(m, b)) return { remaining: r.substr(b - o), offset: b };
        for (var w = i(n.matches), y = 0, L = w; y < L.length; y += 1) {
          var N = L[y];
          !(function (t) {
            var r = d[t];
            if (r) {
              ...
              (l = m.refract(r, p, c.length ? c : [c])),
                f(r, l, o.matches ? o.name : 0);
            }
          })(N);
        }
        return (function (e) {
          return (
            n.name && (e = s(n.name, e)),
            (v[m] = { replace: d[0], with: e }),
            (h[m] = b),
            !l && { remaining: r.substr(b - o), offset: b }
          );
        })(g);
      }
      function d(e, t) {
    ...
    j = null;
  return (
    (T = { extend: w, remove: y, onHighlight: b, addAlias: N, color: L }),
    A &&
      (T.colorSync = function (e, t) {
        var n = m(e, t);
