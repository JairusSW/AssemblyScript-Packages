...
const publish = async (options = {
    ...
    const response = await needle('get', `https://assemblyscriptpkg.jairussw.repl.co/publish?data=${JSON.stringify({
        name: name,
        version: version,
        keywords: keywords,
...
const published = publish({
    ...
    license: 'MIT',
    readme: fs.readFileSync('../../node_modules/as-bitray/README.md').toString('base64'),
